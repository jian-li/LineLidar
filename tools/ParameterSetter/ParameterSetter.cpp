...
int main()
{
    ...
    Mat gray_image;
    Mat image_raw  = Mat::zeros(1000, 1000, CV_8UC3);
    ...
    for(;;)
    {
        ...
        //     {
        //         constrast_brightness_adjusted_image.at<uchar>(x,y) = gray_image.at<uchar>(x,y) * alpha_value + beta_value;
        //     }
        // }
